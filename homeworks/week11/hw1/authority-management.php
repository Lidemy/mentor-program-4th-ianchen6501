        ...
        <tr>
          ...
          <td class="users-info__table__radio">
            <form class='board__new-comment-form' method='POST' action='handle_authority-management.php'>
              <div><label><input type="radio" name='authority' value= 1 >管理者(1)</label></div>
              <div><label><input type="radio" name='authority' value= 2 >ㄧ般使用者(2)</label></div>
              <div><label><input type="radio" name='authority' value= 3 >禁止發言(3)</label></div>
